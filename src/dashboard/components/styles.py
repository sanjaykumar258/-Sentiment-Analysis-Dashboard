...
PLOTLY_LAYOUT = dict(
    **_PLOTLY_BASE,
    ...
    title=dict(text="", font=dict(family="Inter, sans-serif", color="#FFFFFF", size=15)),
...
PLOTLY_LAYOUT_LIGHT = dict(
    **_PLOTLY_BASE,
    ...
    title=dict(text="", font=dict(family="Inter, sans-serif", color="#000000", size=16, weight=800)),
    xaxis=dict(gridcolor="rgba(0,0,0,0.08)", linecolor="#000000",
               tickfont=dict(size=11, color="#000000", weight=700),
               title=dict(font=dict(color="#000000", size=13, weight=700))),
    yaxis=dict(gridcolor="rgba(0,0,0,0.08)", linecolor="#000000",
               tickfont=dict(size=11, color="#000000", weight=700),
               title=dict(font=dict(color="#000000", size=13, weight=700))),
    legend=dict(bgcolor="rgba(255,255,255,0.9)", bordercolor="rgba(0,0,0,0.1)", borderwidth=1, font=dict(size=11, color="#000000")),
    hoverlabel=dict(bgcolor="#FFFFFF", bordercolor="rgba(0,0,0,0.2)", font=dict(family="Inter", size=12, color="#000000")),
)
